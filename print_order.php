...
<!--<p align="left" style="border-top: 1px solid #888; margin-bottom: 0.08in; padding-top: 0.1in; line-height: 100%; font-size: medium; padding-bottom: 0.2in;"><span>Net Qty:</span> <?php // echo $totalQuantity; ?> <span style="float:right;">Bill Total :  Rs. <?php // echo $result['amount'];  ?></span></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 0.4; font-size: medium; padding-bottom: 0.02in; text-align: right;"><span>&nbsp;</span>  <span style="float: none;">Vat@<?php // echo Tax; ?>% : Rs. <?php // echo $result['tax']; ?></span></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 0.4; font-size: medium; padding-bottom: 0.02in; text-align: right;"><span>&nbsp;</span>  <span style="float: none;">S.Tax With SBC & KKC @<?php // echo Surcharge; ?>% : Rs. <?php // echo $result['surcharge']; ?></span></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 0.4; font-size: medium; padding-bottom: 0.02in; text-align: right;"><span>&nbsp;</span>  <span style="float: none;">Discount. : <?php // echo $result['discamount']; ?></span></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 0.4; font-size: medium; padding-bottom: 0.2in; text-align: right;"><span>&nbsp;</span>  <span style="float: none;">R. Off. : <?php // echo round(($result['amount'] +$result['tax'] + $result['surcharge'] - $result['discamount']  - $result['total']), 2); ?></span></p>
<p align="left" style="border-top: 1px solid #888; border-bottom: 1px solid #888; margin-bottom: 0.08in; line-height: 0.9; font-size: medium; padding-bottom: 0.1in; padding-top: 0.1in; text-align:center;"><span>Amount Payable </span>  <span style="float: right;">Rs.  <?php // echo round($result['total']); ?></span></p>
<p align="left" style=" padding-top: 0.04in; margin-bottom: 0.04in; line-height: 100%; text-align: right; font-size: medium;">E&amp;OE</p>
<p align="left" style=" padding-top: 0.04in; margin-bottom: 0.04in; line-height: 100%; text-align: left; font-size: medium;">Payment Mode &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php // echo $paytype; ?></p>
<p align="left" style="margin-bottom: 0.04in; line-height: 100%; text-align: left; font-size: medium;">Card No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php // echo $token; ?></p>
<p align="left" style="margin-bottom: 0.04in; line-height: 100%; text-align: left; font-size: medium;">Card Balance&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Rs. <?php // echo ($balance + round($result['total']) -30); ?></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 100%; text-align: left; font-size: medium;">Bill Amount&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Rs. <?php // echo round($result['total']); ?></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 100%; text-align: left; font-size: medium;">Current Balance&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Rs. <?php // echo ($balance - 30); ?></p>
<p align="left" style="margin-bottom: 0.08in; line-height: 100%; text-align: left; font-size: medium;">
<p align="center" style="margin-top:0.4in; margin-bottom: 0in; line-height: 120%; text-align: center; font-size: medium; width: 100%; border-top: 1px solid #888; border-bottom: 1px solid #888; padding-bottom: 0.2in;"><br/>Order No: <?php // echo $counter; ?></p>
<p align="center" style="margin-bottom: 0in; line-height: 150%; text-align: center; font-size: medium; width: 100%;"><br/><br/></p>
-->
