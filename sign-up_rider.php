                ...
                <?php } ?>
                    <div class="create-account line-dro">
                        ...
                        <span class="newrow">
							...
							<input type="text" placeholder="<?=$langage_lbl['LBL_PROFILE_RIDER_YOUR_EMAIL_ID']; ?>" value="" name="vEmail" id="vEmail_verify" class="create-account-input"/></strong>
                    ...
                    <div class="create-account">
                        ...
                        <span class="newrow">
                            ...
                            <input value="" name="vName" type="text" class="create-account-input" placeholder="<?=$langage_lbl['LBL_FIRST_NAME_HEADER_TXT']; ?>" id="vName"/></strong>
                        ...
                        <span class="c_code_ph_no newrow">
                            ...
                            <strong class="ph_no" id="mobileCheck"><input type="text"  id="vPhone" placeholder="<?=$langage_lbl['LBL_777-777-7777']; ?>" value="" class="create-account-input create-account-input1 vPhone_verify" name="vPhone" /></strong>
