                    ...
                    <div class="driver-profile-page">                    
						...
						<div class="driver-profile-top-part" id="hide-profile-div">
							...
							<div class="driver-profile-info">
								<h3><?=$generalobj->cleanall(htmlspecialchars($db_user[0]['vName'])) . ' ' . $generalobj->cleanall(htmlspecialchars($db_user[0]['vLastName'])); ?><?if($db_user[0]['vAvgRating'] != 0){?><b style="font-size: 14px;">&nbsp;&nbsp;<?= $db_user[0]['vAvgRating']?> (<img src="assets/img/star.jpg" alt="">)</b><?php }?></h3>
								<?php 
									if($country != ""){ ?>
