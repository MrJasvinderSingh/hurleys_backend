...
$sql_cat = "SELECT fm.iFoodMenuId,fm.vMenu_EN,c.vCompany,c.iServiceId FROM food_menu AS fm LEFT JOIN `company` as c ON c.iCompanyId=fm.iCompanyId WHERE fm.iCompanyId = $iCompanyId AND fm.eStatus = 'Active'";
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <!--    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label><?php echo $langage_lbl['LBL_MENU_ITEM_IMAGE']?></label>
                                    </div>
                                    <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                  ...
                                  <div class="col-lg-12">
                                      <div class="panel panel-default">
                                          <div class="panel-heading">
                                              <div class="row" style="padding-bottom:0;padding-top: 0;">
                                                  <div class="col-lg-6"><h5><b><?php echo $langage_lbl['LBL_OPTIONS_MENU_ITEM']?></b> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Use this feature if you want to provide different options or combos for same item (i.e Pizza Base or Combos). Price   will be additional price which will added in base price. '></i></h5></div>
									  ...
									  <div class="panel panel-default" <?php if($db_menu[0]['iServiceId'] != '1'){ ?> style="display:none;" <?php } ?>>
                                          <div class="panel-heading">
                                              <div class="row" style="padding-bottom:0;padding-top: 0;">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <small><?php echo $langage_lbl['LBL_NOTE_FRONT']?> The % discount will be applied on Item price which includes (Base + options + toppings) prices.<br/> The item discount will only apply if the Global Offer " Offer Applies On" is set “NONE” from the restaurant setting. If your current offer type is “All order/ First Order” then, this discount won't apply.]</small>
                                    </div>
                                </div>
								<div class="row servicecatresponsive" <?php if($db_menu[0]['iServiceId'] != '1'){ ?> style="display:none;" <?php } ?>>
                                  <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <select class="form-control" name="vHighlightName"  id="vHighlightName">
                                            ...
                                            <option value="LBL_BESTSELLER" <?if($vHighlightName == 'LBL_BESTSELLER'){echo 'selected';}?>><?php echo $langage_lbl['LBL_BESTSELLER']?></option>
                                            <option value="LBL_NEWLY_ADDED" <?if($vHighlightName == 'LBL_NEWLY_ADDED'){echo 'selected';}?>><?php echo $langage_lbl['LBL_NEWLY_ADDED']?></option>
                                            <option value="LBL_PROMOTED" <?if($vHighlightName == 'LBL_PROMOTED'){echo 'selected';}?>><?php echo $langage_lbl['LBL_PROMOTED']?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                              <input type="submit" class="btn btn-default" name="btnsubmit" id="btnsubmit" value="<?= $action; ?> <?php echo $langage_lbl['LBL_MENU_ITEM_FRONT'];?>" >
                            </div>
                        </div>
                    </div>
                </form>
...
<link href="assets/css/imageUpload/bootstrap-imageupload.css" rel="stylesheet">
    <script>
      function changeDisplayOrder(foodId, menuId, parentId)
      {
          ...
          $.ajax({
              type: 'post',
              url: 'admin/ajax_display_order.php',
      ...
      if (successMSG1 != '') {
        ...
        if ($('#menuItem_form').length !== 0) {
            $('#menuItem_form').validate({
                ...
                messages: {
                    iCompanyId: {
                        required: 'Please Select Restaurant For Add Menu Item.'
                    },
                    iFoodMenuId: {
                        required: 'Please Select Food Menu Category.'
                    },
					 eFoodType: {
                        required: 'Please Select Food Type.'
                    },
                    fPrice: {
                        required: 'Please Add Menu Item Base/Starting/Regular  Price.'
                    }
                },
