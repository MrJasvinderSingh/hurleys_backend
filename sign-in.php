            ...
            <div class="page-contant-inner">
                ...
                <div class="sign-in">
					<div class="sign-in-driver">
						<h3><?=$langage_lbl['LBL_COMPANY_SIGNIN_PAGE'];?></h3>
							<p><?=$langage_lbl['LBL_SIGN_NOTE3'];?></p>
							<span><a href="company-login"><?=$langage_lbl['LBL_SIGNIN_STORE_SIGNIN_CTEXT'];?><img src="assets/img/arrow-white-right.png" alt="" /></a></span>
						</div>
                    <div class="sign-in-driver">
