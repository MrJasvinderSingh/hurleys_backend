...
if($cmenupremium != 0)
{
$LoyalityAppPre = $cmenupremium / 100;
}
$RestaurantPre = 0;
if($rmenupremium !=0)
{
...
$MenuUpdateQuery = "UPDATE `menu_items` set `fPrice` = ROUND( (`fbPrice` + (`fbPrice` * $LoyalityAppPre) + (`fbPrice` * $RestaurantPre)), 2), `cpremium` = ROUND((`fbPrice` * $LoyalityAppPre) , 2), `rpremium` = ROUND((`fbPrice` * $RestaurantPre) , 2) WHERE`iMenuItemId` = $MenuItem[iMenuItemId]";
...
$MenuOptionUpdateQuery = "UPDATE `menuitem_options` set `fPrice` = ROUND( (`fbPrice` + (`fbPrice` * $LoyalityAppPre) + (`fbPrice` * $RestaurantPre)), 2), `cpremium` = ROUND((`fbPrice` * $LoyalityAppPre) , 2), `rpremium` = ROUND((`fbPrice` * $RestaurantPre) , 2) WHERE`iOptionId` = $MenuOPtion[iOptionId]";
...
<!--<div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <small>Online: Tablet in office, Tablet : Using LoyalityApp Res. App, Wallet: Driver Pay for it.</small>
                                            </div>
                                        </div>-->
...
<!-- Restaurant type close -->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--<div class="row">
                                            <div class="col-lg-12">
                                                <label>LoyalityApp Menu Premium (%)</label>
                                            </div>
                                            <div class="col-lg-12">-->
                                                <input type="hidden" class="form-control" name="cpremium"  id="cpremium" value="<?= $cpremium; ?>" placeholder="LoyalityApp Menu Premium" >
                                            <!--</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
