...
if (isset($_POST['btnsubmit'])) {
    ...
    for ($i = 0; $i < count($vTitle_store); $i++) {
        ...
        $fPrice = round(($fbPrice + ($fbPrice * $LoyalityAppPre) + ($fbPrice * $RestaurantPre)) ,2);
        $cpremium = round(($fbPrice * $LoyalityAppPre), 2);
        ...
        if(count($baseOptionOldData) > 0) {
            ...
            if(count($base_array) > 0){
                foreach ($base_array as $key => $value) {
                    ...
                    $BasefPrice = round(($value['fbPrice'] + ($value['fbPrice'] * $LoyalityAppPre) + ($value['fbPrice'] *$RestaurantPre)), 2);
                    $BaseCpremium = round(($value['fbPrice'] * $LoyalityAppPre) ,2 );
        ...
        if(count($addonOptionOldData) > 0){
            ...
            if(count($addon_array) > 0){
                foreach ($addon_array as $key => $value) {
                    ...
                    $AOfPrice = round(($value['fbPrice'] + ($value['fbPrice'] * $LoyalityAppPre) + ($value['fbPrice'] *$RestaurantPre)), 2);
                    $AOCpremium = round(($value['fbPrice'] * $LoyalityAppPre) ,2 );
...
<!--                                <div class="row" >
                                    <div class="col-lg-12">
                                        <label><?php //echo "LoyalityApp Menu Premium" ?></label>
                                    </div>
                                    <div class="col-lg-12">
