<?php
    ...
    $sql = "  SELECT * FROM cancel_reason where 1=1  $ssql $ord LIMIT $start, $per_page";
            ...
            <div id="content">
                <div class="inner">
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2><?=$langage_lbl_admin["LBL_CANCEL_REASON_TXT_ADMIN"];?></h2>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                        ...
                                        <option value="vTitle_<?=$default_lang;?>" <?php if ($option == "vTitle_".$default_lang) { echo "selected"; } ?> >Reason</option>
                                    ...
                                    <td width="12%">
                                        ...
                                        <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='cancel_reason.php'"/>
                                    </td>
                                    ...
                                    <form class="_list_form" id="_list_form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                              ...
                                              <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">Reason <?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                           ...
                                                           <td width="10%" align="center"><?php echo $data_drv[$i]['iDisplayOrder']; ?></td>
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                ...
                                                                <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iCancelReasonId']; ?>">
                                                                    <ul>
                                                                        <li class="entypo-twitter" data-network="twitter"><a href="cancel_reason_action.php?id=<?= $data_drv[$i]['iCancelReasonId']; ?>" data-toggle="tooltip" title="Edit">
                                                                            <img src="img/edit-icon.png" alt="Edit">
                                                                        </a></li>
                                                                        <?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                                            <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iCancelReasonId']; ?>','Inactive')"  data-toggle="tooltip" title="Make Active">
                                                                                <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                            </a></li>
                                                                            <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iCancelReasonId']; ?>','Active')" data-toggle="tooltip" title="Make Inactive">
