...
//$Startdate = date('Y-m-d', strtotime('-0 days', strtotime(date('Y-m-d')))) . ' 00:00:01';
...
$PLOrderQ = "SELECT COUNT(`iOrderId`) AS 'tcount' FROM `orders` where iStatusCode in (1,12) AND tOrderRequestDate BETWEEN '$Startdate' AND '$Enddate';";
...
$CANCOrderQ = "SELECT COUNT(`iOrderId`) AS 'tcount' FROM `orders` where iStatusCode = 8 AND tOrderRequestDate BETWEEN '$Startdate' AND '$Enddate';";
$CANCOrderO = $obj->MySQLSelect($CANCOrderQ);

$ADTOrderQ = "SELECT SEC_TO_TIME ( AVG ( TIMESTAMPDIFF ( SECOND, `pickuptime`,`deliverytime`))) as adt FROM orders where iStatusCode = 6 AND tOrderRequestDate BETWEEN '$Startdate' AND '$Enddate';";
$ADTOrderO = $obj->MySQLSelect($ADTOrderQ);
                ...
                <div class="inner" style="min-height: 700px;">
                    <div class="row">
                        <div class="col-lg-12 operationdash_title">
                            <h1 class="pull-left">Operations Center</h1>
                ...
                <div class="modal bd-example-modal-lg" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body appendpopdata">
                            </div>
