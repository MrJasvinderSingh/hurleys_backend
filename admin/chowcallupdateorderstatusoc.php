...
if ($_POST['action'] == 'assignorder') {
   ...
   // echo "<pre>"; print_r($resultData); echo "</pre>";
    ...
    if ($_POST['iStatusCode'] == 5) {
        ...
        $assignorder = LoyalityAppUpdateOrderStatus($_POST['iOrderId'], $orderStatus);
        ...
        $assignorder = LoyalityAppCancelOrder($_POST['iOrderId']);
...
//print_r($_POST);
//echo "</pre>";
function LoyalityAppCancelOrder($iOrderId) {
    global $generalobj, $obj;
    $hdn_del_id = $iOrderId;
...
function LoyalityAppUpdateOrderStatus($iOrderId, $orderStatus) {
    $responseCStatus = '';
    global $generalobj, $obj;
