...
$sql = "SELECT count(vt.iVehicleTypeId) AS Total FROM  vehicle_type AS vt WHERE 1 = 1 $ssql";
                                ...
                                <tr>
                                    <td width="5%"><label for="textfield"><strong>Search:</strong></label></td>
                                      ...
                                      <option value="vt.vVehicleType_<?=$default_lang?>" <?php if ($option == "vt.vVehicleType_".$default_lang) { echo "selected"; } ?> >Type</option>
                                       <option value="vt.fDeliveryCharge" <?php if ($option == 'vt.fDeliveryCharge') {echo "selected"; } ?> >Delivery Charges Per Order For Completed Orders</option> 
                                       <option value="vt.fDeliveryChargeCancelOrder" <?php if ($option == 'vt.fDeliveryChargeCancelOrder') {echo "selected"; } ?> >Delivery Charges Per Order For Cancelled Orders</option>
                                      <option value="vt.fRadius" <?php if ($option == 'vt.fRadius') {echo "selected"; } ?> >Delivery Radius</option>
                                    </select>
                                    </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                      ...
                                                      <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">Delivery Charges Per Order For Completed Orders <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                      <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">Delivery Charges Per Order For Cancelled Orders <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                      <th width="20%"><a href="javascript:void(0);" onClick="Redirect(3,<?php if($sortby == '3'){ echo $order; }else { ?>0<?php } ?>)">Delivery Radius <?php if ($sortby == 3) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
