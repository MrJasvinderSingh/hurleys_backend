                  ...
                  <tbody>
                    <?  foreach ($db_currency as $key => $value) {
															echo '<tr>
																	...
																	<td><input class="form-control" name="Ratio[]" id="ratio_'.$value['iCurrencyId'].'" type="text" value='.$value['Ratio'].' required/><input class="form-control" name="fThresholdAmount[]" type="hidden" value='.$value['fThresholdAmount'].' /></td>
