...
if($eStatus != ''){
   $eStatussql = "";
    ...
    $eStatussql = " AND dv.eStatus != 'Deleted' AND rd.eStatus != 'Deleted'";
}
...
$sql = "SELECT dv.iDriverVehicleId, dv.iDriverId, dv.eStatus, m.vMake, md.vTitle,CONCAT(rd.vName,' ',rd.vLastName) AS driverName FROM driver_vehicle dv, register_driver rd, make m, model md WHERE 1=1 AND dv.iDriverId = rd.iDriverId  AND dv.iModelId = md.iModelId AND dv.iMakeId = m.iMakeId $eQuery $ssql $dri_ssql $ord LIMIT $start, $per_page";
