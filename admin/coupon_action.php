        ...
        <span style="color:red; font-size:small;" id="coupon_status"></span>
          ...
          <form name="_coupon_form" id="_coupon_form" method="post" action="" enctype="multipart/form-data" class="">
            ...
            <div class="row coupon-action-n1">
              ...
              <div class="col-lg-6">
                <input type="text" class="form-control" name="vCouponCode" <?php if ($action == 'Edit') { echo "readonly" ; }else{?>  <?}?> id="vCouponCode" value="<?= $vCouponCode; ?>" placeholder="Coupon Code" maxlength="30">
            ...
            <div class="row coupon-action-n2">
              ...
              <div class="col-lg-6">
                ...
                <select id="eType" name="eType" class="form-control">
                  ...
                  <option value="cash" <?php if($db_data[0]['eType'] == "cash"){ ?>selected <?php }?> >Flat Amount<!-- <?=$db_currency[0]['vSymbol']?> --></option>
                </select>
              </div>
            </div>
            <div class="row">
