<?php
	...
	if(isset($_POST['submit'])) {
		...
		if(empty($tLongitude) || empty($tLatitude)) {
			...
			if ($action == "Add") {
	            $_SESSION['success'] = '1';
	            $_SESSION['var_msg'] = 'Driver Location inserted successfully.';
	        } else {
	            $_SESSION['success'] = '1';
	            $_SESSION['var_msg'] = 'Driver Location Updated Successfully.';
	        }
	...
	// for Edit
	if($action == 'Edit') {
		$sql = "SELECT lm.*,c.vCountry FROM location_master_driver AS lm LEFT JOIN country AS c ON c.iCountryId= lm.iCountryId WHERE lm.iLocationId = '".$id."'";
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?=$action;?> Delivery Location</h2>
							<a href="deliverylocation.php">
					...
					<div class="body-div">
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="form-group">
									<form method="post" name="location_form" id="location_form" action="">
										...
										<input type="hidden" name="backlink" id="backlink" value="deliverylocation.php"/>
										...
										<div class="row">
										 ...
										 <div class="row">
											<div class="col-lg-12">
												<label>Maximum Order Number<span class="red"> *</span></label>
											</div>
											<div class="col-lg-6">
												<input type="text" class="form-control" name="mon"  id="mon" value="<?=$mon;?>" placeholder="Maximum Order Number" required>
											</div>
										</div>
                                                                                 <div class="row">
											<div class="col-lg-12">
												<label>Maximum Allocation Time<span class="red"> *</span></label>
											</div>
											<div class="col-lg-6">
												<input type="text" class="form-control" name="mat"  id="mon" value="<?=$mat;?>" placeholder="Maximum Allocation Time" required>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-lg-12">
		                                        ...
		                                        <a href="deliverylocation.php" class="btn btn-default">Cancel</a>
											</div>
										</div>
									</form>
								</div>
							...
							<div class="col-lg-7">
								...
								<p><span>Please select the area by putting the points around it. Please <a href="#" target="_blank" alt="Link"><b>click here</b></a> to view how to select the area and add it.</span></p>
