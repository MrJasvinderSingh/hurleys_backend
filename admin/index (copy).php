...
<html lang="en-US">
	...
	<body class="nobg loginPage">
		...
		<div class="container animated fadeInDown">
			<div class="text-center"> <img src="images/<?php echo $logo;?>" id="Admin" alt=" Admin" /> </div>
				...
				<div id="login" class="tab-pane active">				
					...
					<div class="admin-home-tab">
						<ul class="nav nav-tabs">
                                                    <li style="width:25%;" class="active" onClick="setCredentials('1', '<?=SITE_TYPE;?>');passLoginid('super001','1');"><a data-toggle="tab" href="#super001">Super Administrator</a></li>
							...
							<li style="width:25%;" onClick="setCredentials('3', '<?=SITE_TYPE;?>');passLoginid('billing001','3');"><a data-toggle="tab" href="#billing001">Billing Administrator</a></li>
                                                        <li style="width:25%;" onClick="setCredentials('4', '<?=SITE_TYPE;?>');passLoginid('manager001','4');"><a data-toggle="tab" href="#manager001">Manager Administrator</a></li>
						</ul>
		...
		<script>
			...
			function passLoginid(tabid,login_group_id) {
				...
				}else if(tabid == "manager001") {
					$("label[for = email]").text("Manager Administrator E-mail");  
				} else {
