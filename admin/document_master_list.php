...
$sql = "SELECT dm.doc_masterid, dm.doc_usertype , dm.doc_name, dm.status , c.vCountry FROM `document_master` AS dm LEFT JOIN `country` AS c ON c.vCountryCode=dm.country WHERE 1=1 $eStatussql $ssql $ord LIMIT $start, $per_page"; 
