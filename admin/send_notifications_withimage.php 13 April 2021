<?php
   ...
   if (isset($_POST['submit'])) {
   		...
   		//echo '<pre>';print_r($iRiderId);print_r($userArr);die;
      ...
      <div id="wrap">
         ...
         <div id="content">
            <div class="inner">
               <div class="row">
                  <div class="col-lg-12">
                     <h2><?php echo $captionoffer; ?> Offer </h2>
                     <a href="offers.php" class="add-btn">Back</a>
                  </div>
               </div>
               <hr />
               <div class="body-div">
                  <div class="form-group">
                     ...
                     <form id="_notification_form" name="_notification_form" method="post" action="javascript:void(0);" enctype ="multipart/form-data">
                       ...
                       <!--  <div class="row set-dd-css" id="riderRw" >
                           <div class="col-lg-12">
                           ...
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iRiderId[]' id="iRiderId" multiple data-text="All <php echo $langage_lbl_admin['LBL_RIDERS_ADMIN'] ?>">
                                 ...
                                 <option <php if($iUserId == $db_rdr_list[$i]['iUserId']){ echo 'selected'; } ?> value = "<?= $db_rdr_list[$i]['iUserId'] ?>" ><= $generalobjAdmin->clearName($db_rdr_list[$i]['riderName']); ?></option>
                                 <? } ?>
                              </select>
                           </div>
                        </div> -->
                        <?php /*if(!empty($db_login_cmp_list)) {?>
                        <div class="row set-dd-css" id="logincompanyRw" style="display:none;">
                           <div class="col-lg-12">
                              <label>Select Logged in <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?><span class="red"> *</span></label>
                           </div>
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iCompanyId[]' id="login_iCompanyId" multiple data-text="All Logged in <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?>">
                                 <? for($i=0;$i<count($db_login_cmp_list);$i++){ ?>
                                 <option value = "<?= $db_login_cmp_list[$i]['iCompanyId'] ?>" ><?= $generalobjAdmin->clearName($db_login_cmp_list[$i]['vCompany']); ?></option>
                                 <? } ?>
                              </select>
                           </div>
                        </div>
                        ...
                        <div class="row set-dd-css" id="logindriverRw" style="display:none;">
                           ...
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iDriverId[]' id="login_iDriverId" multiple data-text="All Logged in <?php echo $langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN'] ?>">
                                 <? for($i=0;$i<count($db_login_drv_list);$i++){ ?>
                        ...
                        <div class="row set-dd-css" id="loginriderRw" style="display:none;">
                           ...
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iRiderId[]' id="login_iRiderId" multiple data-text="All Logged in <?php echo $langage_lbl_admin['LBL_RIDERS_ADMIN'] ?>">
                                 <? for($i=0;$i<count($db_login_rdr_list);$i++){ ?>
                        ...
                        <?php } ?>
                        <?php if(!empty($db_inactive_cmp_list)) {?>
                        <div class="row set-dd-css" id="inactive_companyRw" style="display:none;">
                           <div class="col-lg-12">
                              <label>Select Inactive <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?><span class="red"> *</span></label>
                           </div>
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iCompanyId[]' id="inactive_iCompanyId" multiple data-text="All Inactive <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?>">
                                 <? for($i=0;$i<count($db_inactive_cmp_list);$i++){ ?>
                                 <option value = "<?= $db_inactive_cmp_list[$i]['iCompanyId'] ?>" ><?= $generalobjAdmin->clearName($db_inactive_cmp_list[$i]['vCompany']); ?></option>
                                 <? } ?>
                              </select>
                           </div>
                        </div>
                        ...
                        <div class="row set-dd-css" id="inactive_driverRw" style="display:none;">
                           ...
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iDriverId[]' id="inactive_iDriverId" multiple data-text="All Inactive <?php echo $langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN'] ?>">
                                 <? for($i=0;$i<count($db_inactive_drv_list);$i++){ ?>
                        ...
                        <div class="row set-dd-css" id="inactive_riderRw" style="display:none;">
                           ...
                           <div class="col-lg-6">
                              <select class="form-control filter-by-text" name = 'iRiderId[]' id="inactive_iRiderId" multiple data-text="All Inactive <?php echo $langage_lbl_admin['LBL_RIDERS_ADMIN'] ?>">
                                 <? for($i=0;$i<count($db_inactive_rdr_list);$i++){ ?>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <label>Image (2000 height x 2000 width)</label>
                           </div>
                           <div class="col-lg-6">
                        ...
                        <div class="hide_for_news" <?php echo $showfields; ?>>
	                        <div class="row">
	                           <div class="col-lg-12">
                              ...
                              <input type="hidden" class="form-control" name ='etype' id="etype" value="Offer">
                              <input type="hidden" class="form-control" name ='eUserType' id="eUserType" value="rider"><input type="hidden" class="form-control" name ='iRiderId[]' id="iRiderId" value="">
	                        ...
	                        <div class="row">
	                           ...
	                           <div class="col-lg-6">
	                              <textarea name="tMessage" class="form-control" id="tMessage" ><?php echo $tMessage; ?></textarea>
	                           </div>
	                        </div>
	                        <div class="row">
	                           <div class="col-lg-12">
	                           ...
	                           <div class="col-lg-6">
	                              <input type='number' name="ipoints" value='<?php echo $ipoints; ?>' class="form-control" id="ipoints" />
	                           </div>
	                        </div>
	                        <div class="row">
	                           <div class="col-lg-12">
	                           ...
	                           <div class="col-lg-6">
	                              <input type='text' name="vexpireIn" value='<?php echo $vexpireIn; ?>' class="form-control" id="vexpireIn" />
	                           </div>
	                        </div>
	                        <div class="row">
	                           <div class="col-lg-12">
	                           ...
	                           <div class="col-lg-6">
	                              <input type='text' name="dExpiryDate" value='<?php echo $dExpiryDate; ?>' class="form-control expirydate" id="datepicker"  data-provide="datepicker"/>
	                           </div>
	                        </div>
                        </div>
                        <div class="row">
                           <div class="col-lg-12">
                              <input type="submit" class="btn btn-default" name="submit" id="submit" onClick="submit_form();" value="Send Offer" >
                           </div>
                        </div>
                     </form>
                  </div>
            ...
            $('.selectype').change(function(){
         	...
         	function submit_form(){
         		...
         		if( $("#_notification_form").valid() ) {
         			...
         			// if(confirm("Confirm to send offers to "+joinTxt+"?")){
         	...
         	$('#etype').change(function(){
         		if($(this).val() == 'News'){
         			if($('#iPushnotificationId').val() == 0){
         				$('#imagefile').attr('required',true);
         			}
         		}else{
         			$('#imagefile').attr('required',false);
            ...
            if (typeof (fileUpload.files) != "undefined") {
                ...
                reader.onload = function (e) {
                    ...
                    image.onload = function () {
                        ...
                        if (height > 310 || width > 450) {
                            $('.error_img').fadeIn().html("Height and Width must not exceed 310*450.");
                                          setTimeout(function() {
