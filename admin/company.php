...
$sql = "SELECT c.iCompanyId, c.vCompany, c.vEmail, c.vCode,c.vPhone, c.eStatus,c.iServiceId, (SELECT count(iFoodMenuId) FROM food_menu WHERE iCompanyId = c.iCompanyId) as foodcatCount FROM company AS c WHERE 1 = 1 $equery $ssql $cmp_ssql $ord LIMIT $start, $per_page";
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="10%" class="padding-right10"><select name="option" id="option" class="form-control">
                                    ...
                                    <option  value="c.vCompany" <?php  if ($option == "c.vCompany") { echo "selected"; }
                                    ?> >Name</option>
                                    <option value="c.vEmail" <?php  if ($option == 'c.vEmail') {  echo "selected";
                                    }  ?> >E-mail</option>
                                    <option value="MobileNumber" <?php if ($option == 'MobileNumber') {  echo "selected"; }
                                    ?> >Mobile</option>
                                    </select>
                                </td>
                                ...
                                <td width="30%"><a class="add-btn" href="company_action.php" style="text-align: center;">Add <?php echo $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN'];?></a></td>
                            </tr>
                        </tbody>
                    </table>
                                                ...
                                                for ($i = 0; $i < count($data_drv); $i++) {
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td style="text-align:center;">
                                                            <?php if($data_drv[$i]['foodcatCount'] > 0 ) { ?>
