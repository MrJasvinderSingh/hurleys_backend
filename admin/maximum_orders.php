...
$script = 'Maximum Orders';

$id     = isset($_REQUEST['id'])?$_REQUEST['id']:'';
$action = isset($_REQUEST['action'])?$_REQUEST['action']:'view';
$iMaximumOrdersId = isset($_REQUEST['iMaximumOrdersId'])?$_REQUEST['iMaximumOrdersId']:'';    
...
$ord = ' ORDER BY dc.iMaximumOrdersId DESC';
if($sortby == 1){
  if($order == 0)
...
if($keyword != ''){
    if($option != '') {
        ...
        $ssql.= " AND lm1.vLocationName LIKE '%".$keyword."%' OR dc.fOrderPriceValue LIKE '%".$keyword."%' OR dc.fDeliveryChargeAbove LIKE '%".$keyword."%' OR dc.fDeliveryChargeBelow LIKE '%".$keyword."%' OR dc.fFreeOrderPriceSubtotal LIKE '%".$keyword."%' OR dc.iFreeDeliveryRadius LIKE '%".$keyword."%' OR dc.eStatus LIKE '%".$keyword."%'";
    }
}

if($option == "eStatus"){ 
  $eStatussql = " AND dc.eStatus = '".ucfirst($keyword)."'";
}else{
...
$sql = "SELECT COUNT(dc.iLocationId) as Total FROM `mo_numbers` dc left join location_master lm1 on dc.iLocationId = lm1.iLocationId WHERE 1 = 1 $eStatussql $ssql";
...
if ($page <= 0)
    $page = 1;
//Pagination End
$sql = "SELECT dc.*,lm1.vLocationName FROM `maximum_orders` dc left join location_master lm1 on dc.iLocationId = lm1.iLocationId WHERE 1 = 1 $eStatussql $ssql $ord LIMIT $start, $per_page";
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
       <title><?=$SITE_NAME?> | Maximum Orders</title>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='maximum_orders.php'"/>
                                    </td>
                                    <td width="30%"><a class="add-btn" href="maximum_orders_action.php" style="text-align: center;">Add Maximum Orders</a></td>
                                </tr>
                              </tbody>
                        </table>
                    ...
                    <div class="table-list">
                                   ...
                                   <!--  <?php if(!empty($data_drv)) {?>
                                    <div class="panel-heading">
                                        <form name="_export_form" id="_export_form" method="post" >
                                            <button type="button" onclick="showExportTypes('maximum_orders')" >Export</button>
                                        </form>
                                   </div>
                                   <?php } ?> -->
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        <td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iMaximumOrdersId']; ?>" />&nbsp;</td>
                                                        ...
                                                        <td><?= $data_drv[$i]['fFreeOrderPriceSubtotal']; ?></td>
                                                        <td><?= $data_drv[$i]['iFreeDeliveryRadius']; ?></td>
                                                        ...
                                                        <td align="center" style="text-align:center;" class="action-btn001">
                                                            <div class="share-button openHoverAction-class" style="display: block;">
                                                                ...
                                                                <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iMaximumOrdersId']; ?>">
                                                                    <ul>
                                                                        <li class="entypo-twitter" data-network="twitter"><a href="maximum_orders_action.php?id=<?= $data_drv[$i]['iMaximumOrdersId']; ?>" data-toggle="tooltip" title="Edit">
                                                                            <img src="img/edit-icon.png" alt="Edit">
                                                                        </a></li>
                                                                        <?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                                        <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iMaximumOrdersId']; ?>','Inactive')"  data-toggle="tooltip" title="Make Active">
                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                        </a></li>
                                                                        <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iMaximumOrdersId']; ?>','Active')" data-toggle="tooltip" title="Make Inactive">
                                                                            <img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >  
                                                                        </a></li>
                                                                        <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatusDelete('<?php echo $data_drv[$i]['iMaximumOrdersId']; ?>')"  data-toggle="tooltip" title="Delete">
                        ...
                        <div class="admin-notes">
                            ...
                            <ul>
                              ...
                              <li>
                                4. You can also define the free delivery radius. Ex. distance from restaurant to user's location up to 1 KM will be free.
                              </li>
                              <li>
...
<form name="pageForm" id="pageForm" action="action/maximum_orders.php" method="post" >
<input type="hidden" name="page" id="page" value="<?php echo $page; ?>">
<input type="hidden" name="tpages" id="tpages" value="<?php echo $tpages; ?>">
<input type="hidden" name="iMaximumOrdersId" id="iMainId01" value="" >
