						...
						<div class="form-group">
							...
							<form method="post" name="_country_form" id="_country_form" action="">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vEmergencycode"  id="vEmergencycode" value="<?=$vEmergencycode;?>" placeholder="Emergency Number" required>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="fTax1"  id="fTax1" value="<?=$fTax1;?>" placeholder="Tax 1">
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="fTax2"  id="fTax2" value="<?=$fTax2;?>" placeholder="Tax 2">
									</div>
								</div>
