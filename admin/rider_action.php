...
$tDestinationAddress = isset($_POST['tDestinationAddress']) ? $_POST['tDestinationAddress'] : '';
$physicalcardnumber = isset($_POST['physicalcardnumber']) ? $_POST['physicalcardnumber'] : '';
    ...
    $strng = '';
      ...
      $strng = "`tRegistrationDate` = '".date("Y-m-d H:i:s")."',";
		...
		$query = $q . " `" . $tbl_name . "` SET
			...
			`vPhone` = '" . $vPhone . "',
			`vLang` = '" . $vLang . "',	
			`tDestinationAddress` = '" . $tDestinationAddress . "',					
			`vCountry` = '" . $vCountry . "',
			`eGender` = '" . $eGender . "',
...
if ($action == 'Edit') {
    $sql = "SELECT iUserId, vName, vLastName, vEmail, vPassword, vPhone, vPhoneCode, vCountry, vInviteCode, eStatus, vImgName, vCurrencyPassenger, vLang, eGender, tDestinationAddress, physicalcardnumber,loyalty_card_number FROM " . $tbl_name . " WHERE iUserId = '" . $id . "'";
    ...
    if (count($db_data) > 0) {
        foreach ($db_data as $key => $value) {
			...
			$vLang = $value['vLang'];
			$tDestinationAddress = $value['tDestinationAddress'];
               $physicalcardnumber = $value['physicalcardnumber'];

               $loyaltycardnumber = $value['loyalty_card_number'];
        }
    }
}
?>
                      ...
                      <?php if($id){?>
                          ...
                          <?php  }
										...
										<div class="row">
                                             ...
                                             <div class="col-lg-6"><!-- style="width:50%" -->
												 <textarea type="text" class="form-control" name="tDestinationAddress" rows="3"><?= $tDestinationAddress ?></textarea>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <label>Physical Card Number<span class="red"> *</span></label>
                                             </div>
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="physicalcardnumber" id="physicalcardnumber" placeholder="Physical Card Number" required>
                                             </div>
                                        </div>
                                        ...
                                        <!--<div class="row">
                                             <div class="col-lg-12">
                                                  <label>Physical Card Number Code</label>
                                             </div>
                                             <div class="col-lg-6">
                                        ...
                                        <?php
                                             if($action == 'Edit') {?>
                                             <label>Loyalty Card Number :</label>  <?php  echo $loyaltycardnumber ;?>
