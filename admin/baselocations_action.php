<?php
	...
	if(isset($_POST['submit'])) {
		...
		if(SITE_TYPE=='Demo')
		{
			header("Location:baselocations_action.php?id=".$id.'&success=2');
			exit;
		}

		if(empty($tLongitude) || empty($tLatitude)) {
	       	$var_msg = 'Please select/draw the area on map shown in right hand side.';
	        header("Location:baselocations_action.php?id=".$id.'&success=3&var_msg='.$var_msg);
	        exit;
		} else {
			...
			if ($action == "Add") {
	            $_SESSION['success'] = '1';
	            $_SESSION['var_msg'] = 'Base Location inserted successfully.';
	        } else {
	            $_SESSION['success'] = '1';
	            $_SESSION['var_msg'] = 'Base Location Updated Successfully.';
	        }
	...
	// for Edit
	if($action == 'Edit') {
		$sql = "SELECT lm.*,c.vCountry FROM baselocations AS lm LEFT JOIN country AS c ON c.iCountryId= lm.iCountryId WHERE lm.iLocationId = '".$id."'";
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?=$action;?> Base Location</h2>
							<a href="baselocations.php">
							...
							<div class="col-lg-5">
								<div class="form-group">
									<form method="post" name="location_form" id="location_form" action="">
										...
										<input type="hidden" name="backlink" id="backlink" value="baselocations.php"/>
										...
										<div class="row">
											<div class="col-lg-12">
												<label>Base Name<span class="red"> *</span></label>
											</div>
											<div class="col-lg-6">
										...
										<div class="row">
											<div class="col-lg-12">
		                                        ...
		                                        <a href="baselocations.php" class="btn btn-default">Cancel</a>
											</div>
										</div>
									</form>
								</div>
