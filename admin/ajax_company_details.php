			...
			<div class="modal-content">
				...
				<div class="modal-body" style="max-height: 450px;overflow: auto;"> -->
					...
					<table border="1" class="table table-bordered" width="100%" align="center" cellspacing="5" cellpadding="10px">
						...
						<tr>
							...
							<td>
								<table border="0" width="100%" height="150px" cellspacing="5" cellpadding="5px">
									<tr>
										<td width="140px" class="text_design">Restaurant Name</td>
						...
						<tr>
							<td class="text_design">Restaurant  Address</td>
							<td>
								<?
				...
				<div style="margin-top: 20px; text-align: right;">
					<a href="company_action.php?id=<?=$iCompanyId; ?>" class="btn btn-primary btn-ok" target="blank">Edit Restaurant</a>
