...
<head>
  ...
  <script src="https://maps.google.com/maps/api/js?key=<?= $GOOGLE_SEVER_API_KEY_WEB ?>"
...
@media screen and (min-width: 569px) and (max-width: 45700px)
{
    .changeModalWidth{
        width: 25% !important;
    }
...
<body class="padTop53 ">
  ...
  <div id="wrap">
    ...
    <div id="content">
        ...
        <div class="row">
          <div class="col-lg-12 Top_Blocks">
            <div class="square-block col-md-4">
              ...
              <table>
                <tr>
                  <th><span data-toggle="tooltip" data-placement="top" title="Total Orders">TTL</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Placed">PL</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Accepted">AC</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Assigned">AS</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Picked Up">PU</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Enroute">ER</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Delivered">DEL</span></th>
                  <th><span  data-toggle="tooltip" data-placement="top" title="Cancelled">CL</span></th>
                </tr>
            ...
            <div class="square-block  col-md-4">
              ...
              <table>
                <tr>
                    <th onclick="showPopupRestaurant(1);" style="cursor:pointer;"><span data-toggle="tooltip" data-placement="top" title="Total Restaurants">TTL</span></th>
                  <th onclick="showPopupRestaurant(2);" style="cursor:pointer;">ON</th>
                  <th onclick="showPopupRestaurant(3);" style="cursor:pointer;">OFF</th>
                </tr>
                <tr>
                    <td onclick="showPopupRestaurant(1);" style="cursor:pointer;"><?php echo $TTLRestO[0]['tcount']; ?></td>
                  <td onclick="showPopupRestaurant(2);" style="cursor:pointer;"><?php echo $ONRestO[0]['tcount']; ?></td>
                  <td onclick="showPopupRestaurant(3);" style="cursor:pointer;"><?php echo $OFFRestO[0]['tcount']; ?></td>
                </tr>
              </table>
            </div>
            <div class="square-block  col-md-4">
              <h3>Drivers <span onclick="openFullscreen();" class="pull-right openclose" title='Full Screen'><i
                    class="fa fa-2x fa-border" style="color: #111; cursor: pointer;"></i></span></h3>


              <table>
                <tr>
                    <th><span data-toggle="tooltip" data-placement="top" title="Total Drivers">TTL</span></th>
                  <th><span data-toggle="tooltip" data-placement="top" title="Ready">RY</span></th>
                  <th><span data-toggle="tooltip" data-placement="top" title="Assigned">AS</span></th>
                  <th><span data-toggle="tooltip" data-placement="top" title="Enroute">ER</span></th>
                  <th><span data-toggle="tooltip" data-placement="top" title="Break/Not Available">BK</span></th>
                  <th><span data-toggle="tooltip" data-placement="top" title="Average Delivery Time">ADT</span></th>
                </tr>
                <tr>
        ...
        <div class="row" id="Operation-Dashboard">
          <div class="col-md-3 nopadding">
            <div class="orders_data_dashboard">
              ...
              <ul>
                <li> <button role="button" class="btn btn-sm btn-default raised setclass  active all" id="active"
                    onClick="allorders('', 'active')">Active</button></li>
                <li> <button role="button" class="btn btn-sm btn-default raised setclass" id="delivered"
                    onClick="allorders('', 'delivered')">Delivered</button></li>
                <li> <button role="button" class="btn btn-sm btn-default raised setclass" id="cancelled"
                    onClick="allorders('', 'cancelled')">Cancelled</button></li>
                <li> <button role="button" class="btn btn-sm btn-default raised setclass" id="all"
                    onClick="allorders('', 'all')">All</button></li>
              </ul>
            ...
            <?//=$langage_lbl['LBL_DRIVER'];?>
            <!--" onKeyUp="get_drivers_list(this.value)">-->
            <!--                    </span>-->
          ...
          <div class="col-md-2 nopadding">
               <div class="form-group" style="margin-top:10px;">
              <button role="button" class="btn btn-sm btn-default raised setclass" id="all"
                    onClick="refreshmaps();">Refresh Map</button>
               </div>
            <!--                    <h3 class="list_title"><a href="javascript:void(0);" class="active">All</a></h3>-->
            <!--                    <span>-->
            <!--                        <input name="" type="text" placeholder="Search -->
        ...
        <div class="row">
          <div class="col-md-12">
            <table class="table table-hover table-bordered">
              ...
              <tr>
                <td style="width:50%">
                  <p>Placed (PL), Accepted (AC), Assigned (AS), Picked Up (PU), Enroute (ER), Delivered (DL), Cancelled
                    (CL)</p>
                </td>
                <td style="width:40%">
                ...
                <td style="width:10%">
                    <button type="button" class="order_button_oc" data-toggle="modal" data-target="#CCformulasmodal">Formulas</button>
                </td>
              </tr>
            </table>
          </div>
      ...
      <div style="clear:both;"></div>
      <div id="assign_form" class="modal fade delete_form text-left" role="dialog" style="z-index: 10600;">
        <div class="modal-dialog changeModalWidth">
          <!-- Modal content-->
          <div class="modal-content">

            <div class="modal-header">

              <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: 0px;"><span
                  aria-hidden="true">X</span></button>
              <h4 class="modal-title">Assign/Unassign Order</h4>
            ...
            <form role="form" name="delete_form" id="delete_form1" method="post" action="" class="margin0">
              ...
              <div class="modal-body">
                  <div id="GetLatestDriverListOC"></div>
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-info" id="assign_booking" title="Assign/Unassign">Assign/UnAssign
                  Order</button>
 ...
 .modal-body {
    padding: 2px;
      ...
      <div class="modal bd-example-modal-lg" tabindex="-1" role="dialog"   style="font-size: 15px; z-index: 10500;">
        <div class="modal-dialog changeModalWidth" role="document">
          <div class="modal-content">
            <div class="modal-header text-center" style=" padding: 2px! important; ">
              <h5 class="modal-title" style="margin: 0px auto;font-size: 19px;" >Order <span class="appendpopdataheader"></span></h5>
      ...
      <div id="driver_model" class="modal fade" role="dialog"  style="font-size: 15px;">
        <div class="modal-dialog changeModalWidth" role="document">
          <div class="modal-content">
            <div class="modal-header text-center" style=" padding: 8px! important; ">
              <h5 class="modal-title" style="margin: 0px auto;font-size: 16px;" >Driver</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                  aria-hidden="true">X</span></button>
            </div>
            <div class="modal-body">
       ...
       <!-- Restaurant Popup Modal Popup -->


      <div id="restaurant_model" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="CCRestaurantmodal" style="font-size: 15px;">
        <div class="modal-dialog changeModalWidth" role="document">
          <div class="modal-content">
            <div class="modal-header text-center" style=" padding: 8px! important; ">
              <h5 class="modal-title" style="margin: 0px auto;font-size: 16px;" > Restaurants</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                  aria-hidden="true">X</span></button>
            </div>
            <div class="modal-body">
                <small id ='restaurantTitle'></small>
              <div class="row clearfix appendpopdataRest">
...
<!-- Modal -->
<div class="modal fade" id="CCformulasmodal" tabindex="-1" role="dialog" aria-labelledby="CCformulasmodal">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Hurley's Formulas</h4>
      </div>
      <div class="modal-body">
          <pre>
AGE = Time difference from Order Placed to Current Time in Minutes.

ADT = Average Time Between Order Placed With Order Delivered.

EDT Calculate on Bases of Age and ETA Time.
EDT = ETA - AGE.
EDT = It varies depend upon status of Order.
if AGE > EDT then it will auto increment by 5 minutes.
and in the end if AGE > ETA then EDT = AGE. 

Earning Of Driver = Reimbursement + Bonus + Tips 
          </pre>
      </div>
      <div class="modal-footer">
    ...
    <script>
      ...
      $(document).ready(function () {
        $("#assign_booking").click(function (e) {
          ...
          $.ajax({
            type: "POST",
            url: "LoyalityAppupdateorderstatusoc.php",
            dataType: "html",
            data: $("#delete_form1").serialize(),
            success: function (response) {

              $(".assignDrivermessage").text(response);
              setInterval(function () { $(".assignDrivermessage").text(" "); }, 2000);
              location.reload();
            }
          });
        });
      ...
      jQuery(document).ready(function ($) {
        ...
        $.ajax({
          ...
          success: function (dataHtml) {
            ...
            $.ajax({
              type: "POST",
              url: "get_available_driver_list_in_operationdashboardoc.php",
              dataType: "html",
              data: { type: '' },
      ...
      */
      ...
      function showPopupDriver(driverId) {
        if ($("#driver_popup").is(":visible") && $('#driver_popup ul').attr('class') == driverId) {
          ...
          $.ajax({
            type: "POST",
            url: "get_driver_detail_popupoc.php",
            dataType: "html",
      ...
      $(document).on('click', '.custom-order', function () {
        ...
        $.ajax({
          type: "POST",
          url: "getOnlineDriverListoc.php",
          dataType: "html",
          success: function (driverlist) {
            $('#GetLatestDriverListOC').html(driverlist);
            $('#assign_form').modal('show');
            
          }, error: function (driverlist) {
      ...
      $(document).on('click', '.tdoperationcls', function () {
        ...
        $.ajax({
          type: "POST",
          url: "get_orderinformation_popupoc.php",
          //dataType: "html",
          dataType: "json",
      ...
      $(document).on('click', '.opdrivernamecls', function () {
        ...
        $.ajax({
          type: "POST",
          url: "getdriverOrderDetialsODoc.php",
          dataType: "html",
          // dataType: "json",
...
function makerestaurantoffline(iCompanyId) {
        var result = confirm("Do you really want to change restaurant state?");
        if (result) {
          $.ajax({
            type: "POST",
            url: "getRestauranttoggleoc.php",
            dataType: "html",
            data: { iCompanyId: iCompanyId },
            success: function (response) {
              if (response == 1) {
                  
            $('#restaurantTitle').text('Successfuly change restaurant state');
             setInterval(function () { $('#restaurantTitle').text(" "); }, 2000);
 ...
 function showPopupRestaurant(restype) {
          $.ajax({
            type: "POST",
            url: "getRestaurantListoc.php",
            dataType: "html",
            data: { restype: restype },
            success: function (response) {
                $("#restaurant_model").modal('show');
              $('.appendpopdataRest').html(response);
