	...
	if(!empty($img_arr)) {
		foreach ($img_arr as $key => $value) {
			...
			if(!empty($value['name'])) {
		        ...
		        if ($id != "") {
                	$check_file[$key] = $img_path .'/home/' . $check_file[0][$key];

	                if ($check_file[$key] != '' && file_exists($check_file[$key])) {
	                    @unlink($img_path . '/home/' . $check_file[0][$key]);
	                }
	            }
	...
	<div id="wrap">
		...
		<div id="content">
			<div class="inner">
				<div class="row">
					<div class="col-lg-12">
						<h2><?=$action;?> Home Content <?if(!empty($title)){?> (<?php echo $title;?>)<? } ?></h2>
							...
							<div class="body-div innersection">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($BannerBgImage != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/".$BannerBgImage;?>" class="innerbg_image"/>
											<? } ?>
							...
							<div class="body-div innersection">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($FirstSectionLeftImage != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/".$FirstSectionLeftImage;?>" class="innerbg_image"/>
											<? } ?>
							...
							<div class="body-div innersection">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($MidFirstImage != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/".$MidFirstImage;?>" class="innerbg_image"/>
											<? } ?>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($MidSecImage != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $MidSecImage;?>" class="innerbg_image"/>
											<? } ?>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($MidThirdImage != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $MidThirdImage;?>" class="innerbg_image"/>
											<? } ?>
							...
							<div class="body-div innersection">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($ThirdLeftImg1 != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $ThirdLeftImg1;?>" class="innerbg_image"/>
											<? } ?>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($ThirdLeftImg2 != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $ThirdLeftImg2;?>" class="innerbg_image"/>
											<? } ?>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($ThirdLeftImg3 != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $ThirdLeftImg3;?>" class="innerbg_image"/>
											<? } ?>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($PlayStoreImg != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $PlayStoreImg;?>" class="innerbg_image"/>
											<? } ?>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($AppStoreImg != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $AppStoreImg;?>" class="innerbg_image"/>
											<? } ?>
							...
							<div class="body-div innersection">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-6">
											<? if($AboutUsBgImage != '') { ?>
											<img src="<?=$tconfig["tsite_upload_page_images"]."home/". $AboutUsBgImage;?>" class="innerbg_image"/>
											<? } ?>
