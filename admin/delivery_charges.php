                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                              <tbody>
                                <tr>
                                    ...
                                    <td width="30%"><a class="add-btn" href="delivery_charges_action.php" style="text-align: center;">Add Delivery Charges</a></td>
                                </tr>
                              </tbody>
                        </table>
                                                            ...
                                                            <div class="share-button openHoverAction-class" style="display: block;">
                                                                ...
                                                                <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iDeliveyChargeId']; ?>">
                                                                    <ul>
                                                                        ...
                                                                        <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iDeliveyChargeId']; ?>','Inactive')"  data-toggle="tooltip" title="Make Active">
                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                        </a></li>
                                                                        <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iDeliveyChargeId']; ?>','Active')" data-toggle="tooltip" title="Make Inactive">
