<?
	...
	if(isset($_POST['submit'])) { //form submit
	  if(!empty($iCancelReasonId)){
          if(SITE_TYPE=='Demo')
          {
            header("Location:cancel_reason_action.php?id=".$id."&success=2");
            exit;
          }
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?=$action;?> Home Page <?=$langage_lbl_admin["LBL_CANCEL_REASON_TXT_ADMIN"];?> </h2>
							<a href="cancel_reason.php">
               ...
               <?} ?>
							...
							<form method="post" action="" enctype="multipart/form-data" id="cancel_reason_action" name="cancel_reason_action">
								...
								<input type="hidden" name="backlink" id="backlink" value="cancel_reason.php"/>
								...
								<div class="row">
									...
									<div class="col-lg-12">
                                        ...
                                        <a href="cancel_reason.php" class="btn btn-default back_link">Cancel</a>
                                    </div>
