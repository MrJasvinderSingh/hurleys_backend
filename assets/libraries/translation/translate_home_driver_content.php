<?php
// DEMO LINK http://192.168.1.131/eatcaymanloyalityappdev/translate_home_driver_content.php?vLangCode=es
	...
	if(count($data)>0)
	{
		foreach ($data as $key => $value) {
			...
			if($translateValueDesc == '' && $vAPILangCode != '') {
				...
				$urlDesc = 'http://api.mymemory.translated.net/get?q='.urlencode($englishDescValue).'&de=&langpair=en|'.$vAPILangCode;
