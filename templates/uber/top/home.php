...
<?php } 
if(isset($data[0]['mobile_app_bg_img1']) && (!empty($data[0]['mobile_app_bg_img1']))) {?>
.home-mobile-app {
	background-image: url('<?=$tconfig["tsite_upload_page_images"]."home/".$data[0]['mobile_app_bg_img1'];?>');
	}	
<?php } 
...
<!-- -->
<div class="home-food-app">
	<div class="home-food-app-inner">
		
	<ul>
			<li>
				<div class="home-body-mid-img-a">
				<?php 
				$img1 = isset($data[0]['third_mid_image_one']) ? $tconfig["tsite_upload_page_images"].'home/'.$data[0]['third_mid_image_one'] : 'assets/img/home-box1.jpg';
				?>
				<img src="<?php echo $img1; ?>" alt="home1" />
				</div>
				<h3 class="home-body"><?php echo $data[0]['third_mid_title_one1'];?></h3>
                <h4 class="home-body-a"><?php echo $data[0]['third_mid_desc_one1'];?></h4>
				<?php //echo $data[0]['third_mid_desc_one'];?>
			</li>
			<li>
				<div class="home-body-mid-img-a">
				...
				?>
				<img src="<?php echo $img2;?>" alt="home2" /></div>
				<h3 class="home-body"><?php echo $data[0]['third_mid_title_two1'];?></h3>
                 <h4 class="home-body-a"><?php echo $data[0]['third_mid_desc_two1'];?></h4>
				<?php //echo $data[0]['third_mid_desc_two'];?>
			</li>
			<li>
				<div class="home-body-mid-img-a">
				...
				<h3 class="home-body"><?php echo $data[0]['third_mid_title_three1'];?></h3>
                 <h4 class="home-body-a"><?php echo $data[0]['third_mid_desc_three1'];?></h4>
				<?php //echo $data[0]['third_mid_desc_three'];?>
			</li>
		</ul>
