...
-
-              <li><a href="food_menu.php" class="<?=(isset($script) && $script == 'FoodMenu')?'active':'';?>"><b><i aria-hidden="true" class="fa fa-cutlery"></i></b><span>Food Category</span></a></li>
-
-              <li><a href="menuitems.php" class="<?=(isset($script) && $script == 'MenuItems')?'active':'';?>"><b><i aria-hidden="true" class="fa fa-list-alt"></i></b><span>Menu Items</span></a></li>
-							
