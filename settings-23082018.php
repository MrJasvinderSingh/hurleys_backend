...
<!--                                                 <?php if($id) {?> -->
                                                 <div id="hide-profile-div" class="col-lg-12">
                                                    <!--     <div class="cover-photo">
                                                        <div class="cover-imge-inner-div" id="image_demo">
                                                            <img src = "<?php echo $tconfig["tsite_upload_images_compnay"]. '/' .$id. '/' .$oldvCoverImageImage ?>" class="img-ipm" />
                                                        </div>
                                                        <div class="cover-photo-banner-control">
                                                            <div class="cover-photo-button" style="position: relative;">
                                                                <button type="button" class="btn btn-default actionUpload">Change Cover Photo</button>
