...
//		}
    ...
    $fCommision = 0;
    $fDeliveryCharge = $deliverychargees = getLoyalityAppdeliverycharge();
...
function OrderTotalEarningForLoyalityAppDriver($iGeneralUserId, $vConvertFromDate, $vConvertToDate, $UserType = 'Company', $vTimeZone) {
    global $generalobj, $obj;
    $systemTimeZone = date_default_timezone_get();
...
function getLoyalityAppdeliverycharge() {
    global $generalobj, $obj;
    $deliverycharge = 0;
