    ...
    <!-- End: Left Menu-->
        ...
        <div class="page-contant">
            <div class="page-contant-inner login-part">
                <h2 class="header-page-ab" style="text-align: center;"><?=$langage_lbl['LBL_CONTACT_US_HEADER_TXT']; ?>
                  
                </h2>
              
                  <p class="head-p" style="text-align: center;text-align: center;font-size: 19px;margin: 0 20%;"><?/*=$langage_lbl['LBL_WELCOME_TO']; ?> <?=$SITE_NAME?>, <?=$langage_lbl['LBL_CONTACT_US_SECOND_TXT']; */?>
                  We appreciate your feedback! Please use the form below to send us any comments, questions or concerns.</p>
				  <p style="text-align: center;margin: 10px;font-size: 24px;"><a class="tel" href="tel:345.947.8488">Phone: 345.947.8488</a></p>
				  <p class="lead" style="text-align: center;">Monday-Saturday: 7am-11pm<br>Closed Good Friday, Christmas and New Year’s Day</p>
                <!-- contact page -->
