<?php
	...
	if ($_SESSION['sess_user'] == 'driver') {
		$sql = "select c.iCountryId from `register_driver` AS rd LEFT JOIN country AS c ON c.vCountryCode=rd.vCountry where rd.iDriverId = '" . $_SESSION['sess_iUserId'] . "'";
		    			...
		    			<div class="car-type">
		      				...
		      				<?php
								...
								<li>
									...
									<div class="make-switch radio2" data-on="success" data-off="warning" style="margin:10px 0 0">
