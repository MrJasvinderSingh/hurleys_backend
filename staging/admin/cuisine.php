            ...
            <div id="content">
                <div class="inner">
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                        ...
                                        <option value="cuisineName_<?=$default_lang?>" <?php if ($option == "cuisineName_".$default_lang) { echo "selected"; } ?> >Cuisine</option>
                                        <? if(count($service_cat_data) > 1){ ?>
                                        <option value="vServiceName_<?=$default_lang?>" <?php if ($option == "vServiceName_".$default_lang) {echo "selected"; } ?> >Service Type</option>
                                        <? } ?>
                                    </select>
                                    </td>
                                    ...
                                    <td width="30%"><a class="add-btn" href="cuisine_action.php" style="text-align: center;">Add Cuisine</a></td>
                                </tr>
                              </tbody>
                        </table>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="15%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">Cuisine<?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        <? if(count($service_cat_data) > 1){ ?>
                                                                ...
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions leastcol openPops_<?= $data_drv[$i]['cuisineId']; ?>">
                                                                        <ul>
                                                                            ...
                                                                            <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['cuisineId']; ?>','Inactive')"  data-toggle="tooltip" title="Make Active">
                                                                                <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                            </a></li>
                                                                            <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['cuisineId']; ?>','Active')" data-toggle="tooltip" title="Make Inactive">
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                <li>
                                    Service Category module will list all Service Categories on this page.
                                </li>
                                <li>
