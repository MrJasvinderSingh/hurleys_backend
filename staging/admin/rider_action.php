...
if ($action == 'Edit') {
    $sql = "SELECT iUserId, vName, vLastName, vEmail, vPassword, vPhone, vPhoneCode, vCountry, vInviteCode, eStatus, vImgName, vCurrencyPassenger, vLang, eGender, tDestinationAddress FROM " . $tbl_name . " WHERE iUserId = '" . $id . "'";
