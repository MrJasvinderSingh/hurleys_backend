...
$tbl_name 		= 'service_categories';
	...
	if($hdn_del_id != '') {
		...
		header("Location:service_category.php?success=2");exit;
	   }
	}
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
       <title><?=$SITE_NAME?> | Service Categories</title>
            ...
            <div id="content">
                <div class="inner">
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="vServiceName_<?=$default_lang?>" <?php if ($option == "vServiceName_".$default_lang) { echo "selected"; } ?> >Service Category</option>
                                ...
                                <div class="admin-nir-export">
                                    ...
                                    <span class="col-lg-2 new-select001">
                                        <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                            ...
                                            <option value='Active' <?php if ($option == 'Active') { echo "selected"; } ?> >Service Category Active</option>
                                            <option value="Inactive" <?php if ($option == 'Inactive') {echo "selected"; } ?> >Service Category Inactive</option>
                                            <?php// if($eStatus != 'Deleted') { ?>
                                            <!--<option value="Deleted" <?php //if ($option == 'Delete') {echo "selected"; } ?> >Cuisine Delete</option>-->
                                            <?php// } ?>
                                        </select>
                                    </span>
                                    </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
														...
														<img src="<?=$tconfig["tsite_upload_service_categories_images"].'/'.$data_drv[$i]['vImage'];?>" class="thumbnail" style="max-width: 100px; max-height: 100px;margin:0;"/>
														<?php } ?>
														</td>
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                <li>
                                    Service Category module will list all Service Category on this page.
                                </li>
                                <li>
