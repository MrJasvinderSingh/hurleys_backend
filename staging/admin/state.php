...
$sql = "SELECT s.iStateId, s.vState, c.iCountryId,c.vCountry,s.vStateCode,s.eStatus FROM state AS s LEFT JOIN country AS c ON c.iCountryId = s.iCountryId WHERE s.eStatus !=  'Deleted' $ssql $ord LIMIT $start, $per_page ";
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="s.eStatus" <?php if ($option == 's.eStatus') {echo "selected"; } ?> >Status</option>
                                    </select>
                                    </td>
