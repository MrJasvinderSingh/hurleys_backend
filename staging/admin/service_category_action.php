							...
							<form method="post" name="_service_category_form" id="_service_category_form" action="" enctype='multipart/form-data'>
								...
								<? if($count_all > 0) {
                                    for($i=0;$i<$count_all;$i++) {
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label>Service Name (<?=$vTitle;?>)<?php echo $required_msg; ?></label>
                                            </div>
                                            <div class="col-lg-6">
								...
								<div class="row">
									...
									<?php
											if(!empty($Image)){
											?>
											<img src="<?=$tconfig["tsite_upload_service_categories_images"].'/'.$Image;?>" class="thumbnail" style="max-width: 250px; max-height: 250px"/>
									<?php } ?>
									</div>
								...
								<?php $count1 = "select iServiceId from service_categories";
...
function getAllLanguageCode(){
      ...
      var getEnglishText = $('#vServiceName_'+def_lang).val();
      var error = false;
      var msg = '';
