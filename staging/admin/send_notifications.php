                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <select class="form-control" name = 'eUserType' id="eUserType" onChange="showUsers(this.value);">
                                                  	<option value="company">All <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?></option>
													...
													<option value="logged_company">All Logged in <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?></option>
													<?php } ?>
													...
													<option value="inactive_company">All Inactive <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?></option>
													<?php } ?>
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name ='vTitle' id="vTitle" value="<?= $db_cmp_list[$i]['vTitle'] ?>">
                                                  
                                             </div>
                                        </div>

                                        <div class="row set-dd-css" id="companyRw">
                                             <div class="col-lg-12">
                                                  <label>Select <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?><span class="red"> *</span></label>
                                             </div>
                                             <div class="col-lg-6">
                                                  <select class="form-control filter-by-text" name = 'iCompanyId[]' id="iCompanyId" multiple data-text="All <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_PUSH_NOTIFICATION'] ?>">
													<? for($i=0;$i<count($db_cmp_list);$i++){ ?>
													<option value = "<?= $db_cmp_list[$i]['iCompanyId'] ?>" ><?= $generalobjAdmin->clearName($db_cmp_list[$i]['vCompany']); ?></option>
													<? } ?>
												</select>
                                             </div>
                                        </div>

                                        <div class="row set-dd-css" id="driverRw" style="display: none;">
                                             <div class="col-lg-12">
