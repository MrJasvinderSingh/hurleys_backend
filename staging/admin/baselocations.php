...
$script = 'BaseLocation';
    ...
    if($hdn_del_id != ''){
        ...
        header("Location:baselocations.php?success=2");exit;
    }
    }
...
$sql = "SELECT COUNT(lm.iLocationId) AS Total FROM baselocations as lm LEFT JOIN country as c on c.iCountryId=lm.iCountryId WHERE lm.eStatus != 'Deleted' $ssql";
...
if ($page <= 0)
    $page = 1;
//Pagination End
 $sql = "SELECT lm.*,c.vCountry FROM baselocations as lm LEFT JOIN country as c on c.iCountryId=lm.iCountryId WHERE lm.eStatus != 'Deleted' $ssql $ord LIMIT $start, $per_page ";
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="lm.vLocationName" <?php if ($option == "lm.vLocationName") { echo "selected"; } ?> >Base Name</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='baselocations.php'"/>
                                    </td>
                                    <td width="30%"><a class="add-btn" href="baselocations_action.php" style="text-align: center;">Add Base Location</a></td>
                                </tr>
                              </tbody>
                        </table>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">Base Name<?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th> 
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iLocationId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="baselocations_action.php?id=<?= $data_drv[$i]['iLocationId']; ?>" data-toggle="tooltip" title="Edit">
...
<form name="pageForm" id="pageForm" action="action/baselocations.php" method="post" >
