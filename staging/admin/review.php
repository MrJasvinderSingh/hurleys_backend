                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="o.vOrderNo" <?php if ($option == "o.vOrderNo") { echo "selected"; } ?> >Order Number</option>
                                          <?php if($reviewtype == 'Company') {?>
                                            <option value="c.vCompany" <?php if ($option == "c.vCompany") {echo "selected"; } ?> ><?=$langage_lbl_admin['LBL_COMPANY_NAME_ADMIN'];?> Name</option>
                                          <?php } ?>
                                          <?php if($reviewtype != 'Company') {?>
                                            <option value="drivername" <?php if ($option == "drivername") {echo "selected"; } ?> ><?=$langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN'];?> Name</option>
                                          <?php } ?>
                                          <option value="ridername" <?php if ($option == "ridername") {echo "selected"; } ?> ><?=$langage_lbl_admin['LBL_DASHBOARD_USERS_ADMIN'];?> Name</option>
                      ...
                      <div style="clear:both;"></div>
                          ...
                          <ul class="nav nav-tabs">
                            <li <?php if($reviewtype=='Company'){?> class="active" <?php } ?>>
                              <a data-toggle="tab"  onclick="getReview('Company')"  href="#home" ><?=$langage_lbl_admin['LBL_COMPANY_NAME_ADMIN'];?></a></li>
                              ...
                              <thead>
                                <tr>
                                  ...
                                  <th width="15%"><a href="javascript:void(0);" onClick="Redirect(6,<?php if($sortby == '6'){ echo $order; }else { ?>0<?php } ?>)"> From <?php echo $langage_lbl_admin['LBL_RIDER_NAME_TXT_ADMIN'];?>  Name <?php if ($sortby == 6) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                    
                                  <th width="15%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)"> To <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN'];?>  Name (Average Rate) <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>

                                  <?php } else if($reviewtype=='Company') { ?>
                                   <th width="15%"><a href="javascript:void(0);" onClick="Redirect(6,<?php if($sortby == '6'){ echo $order; }else { ?>0<?php } ?>)"> From <?php echo $langage_lbl_admin['LBL_RIDER_NAME_TXT_ADMIN'];?>  Name <?php if ($sortby == 6) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                    
                                  <th width="15%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)"> To <?php echo $langage_lbl_admin['LBL_COMPANY_NAME_ADMIN'];?>  Name (Average Rate) <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>

                                  <?php } else{?>

																	   <th width="15%"><a href="javascript:void(0);" onClick="Redirect(6,<?php if($sortby == '6'){ echo $order; }else { ?>0<?php } ?>)"> From <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN'];?> Name <?php if ($sortby == 6) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?>  <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                     <th width="15%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)"> To <?php echo $langage_lbl_admin['LBL_RIDER_NAME_TXT_ADMIN'];?>   Name(Average Rate) <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                ...
                                <tr class="gradeA">
                                      ...
                                      ?></td>
																	  ...
																	  <?php } else if($reviewtype=='Company'){ ?>
                                      <td><? echo $generalobjAdmin->clearName($data_drv[$i]['passangerName']); ?></td>
                                      <td><? echo $generalobjAdmin->clearName($data_drv[$i]['vCompany']);
                                     echo " <b dir='ltr'> ( ".$data_drv[$i]['cmpRating']." )</b>";
                                      ?></td>
                                    <?php }else{?>
