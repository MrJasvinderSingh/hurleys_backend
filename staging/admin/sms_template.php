...
$sql = "SELECT COUNT(iSendMessageId) AS Total FROM send_message_templates WHERE 1 = 1 $ssql AND eStatus = 'Active'";
...
$sql = "SELECT * FROM ".$tbl_name." where 1 $ssql AND eStatus = 'Active' $ord LIMIT $start, $per_page ";
