<?php
	...
	$onRides = $generalobjAdmin->getTripStates('on going order');
	$finishRides = $generalobjAdmin->getTripStates('Delivered');
						...
						<div class="chat-panel panel panel-success">
								...
								<?php  for($i=0,$n=$i+2;$i<count($db_finished);$i++,$n++){?>
									<div class="panel-heading" style="background:none;">
										<ul class="chat">
											<?php if($n%2==0){ ?>
											 <a href=<?echo "invoice.php?iOrderId=".$db_finished[$i]['iOrderId'];?> target="_blank"> 
												<li class="left clearfix">

													<span class="chat-img pull-left">
														<? if($db_finished[$i]['vImage']!='' && $db_finished[$i]['vImage']!="NONE" && file_exists( "../webimages/upload/Company/".$db_finished[$i]['iCompanyId']."/".$db_finished[$i]['vImage'])){?>
															<img src="../webimages/upload/Company/<?php echo $db_finished[$i]['iCompanyId']."/".$db_finished[$i]['vImage'];?>" alt="User Avatar" class="img-circle"  height="50" width="50"/>
														<? }else{?>
													...
													<div class="chat-body clearfix">
														<div class="header">
															<strong class="primary-font "> <?php echo $generalobjAdmin->clearName($db_finished[$i]['vCompany']); ?> </strong>
															<small class="pull-right text-muted label label-danger">
																<i class="icon-time"></i>
																<?php
																	$regDate=$db_finished[$i]['tOrderRequestDate'];
														...
														<br />
														<p>
															<?php echo $db_finished[$i]['vCaddress']." --> ".$db_finished[$i]['vServiceAddress']."<br/>";
																echo "<b>Status: ".$db_finished[$i]['vStatus']."</b>";
																echo "<b>&nbsp;&nbsp;&nbsp; Order No: ".$db_finished[$i]['vOrderNo']."</b>";
															?>
														</p>
													</div>
												</li>
												...
												<li class="right clearfix">
													...
													<span class="chat-img pull-right">
														...
														<? if($db_finished[$i]['vImage']!='' && $db_finished[$i]['vImage']!="NONE"){?>
															<?php if(file_exists( "../webimages/upload/Company/".$db_finished[$i]['iCompanyId']."/".$db_finished[$i]['vImage'])){ ?>
															<img src="../webimages/upload/Company/<?php echo $db_finished[$i]['iCompanyId']."/".$db_finished[$i]['vImage'];?>" alt="User Avatar" class="img-circle"  height="50" width="50"/>
														<?php  } else {?>
															<img src="../assets/img/profile-user-img.png" alt="" class="img-circle"  height="50" width="50">
														<?php } ?>
													...
													<div class="chat-body clearfix">
														<div class="header">
															...
															<small class=" text-muted label label-info">
																...
																<strong class="pull-right primary-font"> <?php echo $generalobjAdmin->clearName($db_finished[$i]['vCompany']); ?></strong>
