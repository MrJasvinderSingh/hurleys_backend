...
if (!extension_loaded('openssl')) {
   echo "<br /><span style='color:#FF0000;text-align:center;'>openssl extension <b>is not loaded.</b></span>";
}else{
   echo "<br /><span style='color:#32CD32;text-align:center;'>openssl extension <b>is loaded.</b></span>";
}
if (!extension_loaded('exif')) {
   echo "<br /><span style='color:#FF0000;text-align:center;'>exif extension <b>is not loaded.</b></span>";
}else{
   echo "<br /><span style='color:#32CD32;text-align:center;'>exif extension <b>is loaded.</b></span>";
}
