							...
							<? if(SITE_TYPE=='Demo'){?>
								...
								<?}else{
									...
									<div class="demo-warning">
										...
										<p> 
											<?php if($db_user[0]['eStatus'] == 'inactive') { echo $langage_lbl['LBL_INACTIVE_DRIVER_MESSAGE']; } ?>
										</p>	
										<p>
									...
									<?php
									} else if($db_user[0]['eStatus'] == 'inactive') { ?>
										<div class="demo-warning">
											<p>
						...
						<div class="driver-profile-page">
							...
							<div class="driver-profile-top-part" id="hide-profile-div">
								...
								<div class="driver-profile-info">
									<h3><?if ($_SESSION['sess_user'] == 'driver') { echo  $generalobj->cleanall(htmlspecialchars($db_user[0]['vName'] . " " . $db_user[0]['vLastName'])); }?> &nbsp;&nbsp;<?if($db_user[0]['vAvgRating'] != 0){?><b style="font-size: 14px;"><?= $db_user[0]['vAvgRating']?> (<img src="assets/img/star.jpg" alt="">)</b><?php }?></h3>
