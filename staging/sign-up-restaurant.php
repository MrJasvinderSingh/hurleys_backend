...
<?php 
    ...
    $service_category = "select iServiceId,vServiceName_".$default_lang." as servicename from service_categories where iServiceId IN (".$serviceIds.") AND eStatus = 'Active' ORDER BY servicename asc ";
...
<body>
    ...
    <div class="page-contant">
        <div class="page-contant-inner">
            ...
            <form name="frmsignup" id="frmsignup" method="post" action="signup_r.php">
                ...
                <?php } ?>
                    <div class="create-account">
                        ...
                        <span class="newrow">
                            <strong id="emailCheck">
                                ...
                                <input type="text" Required placeholder="<?=$langage_lbl['LBL_EMAIL_name@email.com']; ?>" name="vEmail" class="create-account-input " id="vEmail_verify" value="<?php echo $_SESSION['s_email'] ; ?><?php echo $vEmail; ?>" />
                            </strong>
						   <strong>
                    ...
                    <div class="create-account">
                        <h3 class="company"><?=$langage_lbl['LBL_Company_Information']; ?></h3>
                        <span class="company newrow">
                            <strong>
                                <label><?=$langage_lbl['LBL_SIGNUP_STORE_NAME']; ?><span class="red">*</span></label>
                                <input type="text" id="company_name" placeholder="<?=$langage_lbl['LBL_SIGNUP_STORE_NAME']; ?>" class="create-account-input" name="vCompany" value="<?php echo $_SESSION['storename']; ?><?php echo $vCompany; ?>"  />
                            </strong>
                            <strong>
                                <label><?=$langage_lbl['LBL_RES_CONTACT_PERSON_NAME']; ?> <span class="red">*</span></label>
                                <input name="vContactName" type="text" class="create-account-input" placeholder="<?=$langage_lbl['LBL_RES_CONTACT_PERSON_NAME']; ?>" value="<?php echo $_SESSION['f_name'] ; ?><?php echo $vContactName; ?>" />
                            </strong>
                        </span>
						<span class="newrow">
							<strong>
					   ...
					   <span class="newrow">
						...
						<span class="newrow">
							...
							<strong>
                                ...
                                <strong class="ph_no newrow" id="mobileCheck"><input required type="text"  id="vPhone" value="<?php echo  $_SESSION['mobile'] ; ?><?php echo $vPhone; ?>" placeholder="<?=$langage_lbl['LBL_SIGNUP_777-777-7777']; ?>" class="create-account-input create-account-input1 vPhone_verify" name="vPhone"/></strong>
