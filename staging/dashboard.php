...
<body>
    ...
    <div id="main-uber-page">
        ...
        <div class="page-contant">
            <div class="page-contant-inner dashboard-page">
				...
				<? } else { ?>
					<div class="demo-warning">
						<p><?= $langage_lbl['LBL_WE_SEE_YOU_HAVE_REGISTERED_AS_A_COMPANY']; ?>
						<? if ($db_user[0]['vCerti'] == '' || $db_user[0]['vNoc'] == ''){ ?>
							<?= $langage_lbl['LBL_KINDLY_PROVIDE_BELOW']; ?>
						<? } ?></p>
						<p>Step 1: Apply the proper settings for your restaurant from "Settings" section. <?//= $langage_lbl['LBL_STEP1']; ?></p>
						<p>Step 2: Add Menu Category and Menu Items. <?//= $langage_lbl['LBL_STEP3']; ?></p>
						<p>Step 3: Login to the Restaurant App and become visible online. <?//= $langage_lbl['LBL_STEP2']; ?></p>
	...
	<script>
	    $('.panel:nth-child(1) .btn').text("Upload Menu");
	</script>
