...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './webimages/resizeImage/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 50485760);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
...
if(! defined('MAX_WIDTH') )					define ('MAX_WIDTH', 8000);								// Maximum image width
if(! defined('MAX_HEIGHT') )				define ('MAX_HEIGHT', 8000);							// Maximum image height
...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 1024);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 1024);							// Default thumbnail height. Allows overrid in timthumb-config.php
